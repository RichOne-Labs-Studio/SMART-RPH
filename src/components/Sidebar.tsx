...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Bagian Bawah: Panel Login / Status Petugas (Tepat di Bagian Bawah Sidebar) */}
          ...
          <div className="p-3.5 rounded-2xl bg-indigo-950/20 border border-indigo-900/40 space-y-3">
            ...
            <div className="space-y-2 pt-1 border-t border-indigo-900/30">
              ...
              <button
                ...
                onClick={onLogout}
                className="w-full py-2 px-3 text-xs font-semibold rounded-xl bg-rose-950/30 hover:bg-rose-900/40 text-rose-300 border border-rose-900/40 transition-all flex items-center justify-center gap-2 mt-2"
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <span className="text-[10px] text-[#94A3B8]">
                  Login untuk kelola & ekspor data
                </span>
              </div>
            </div>
